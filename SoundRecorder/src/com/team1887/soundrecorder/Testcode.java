...
public class Testcode extends Activity{
		 	...
		 	myButton3.setEnabled(false);
		  	...
		  	myButton1.setOnClickListener(new ImageButton.OnClickListener() {
		  		...
		  		public void onClick(View arg0) {
		  			try { 
		  				if (!sdCardExit) {
		  					Toast.makeText(Testcode.this, "请插入SD Card",Toast.LENGTH_LONG).show();
		  					return;
		  				}
		  				// 创建录音频文件
	...
	//	  			}
	  		...
	  		public void onItemClick(AdapterView<?> arg0, View arg1,	int arg2, long arg3) {
	  			...
	  			System.out.println("_______________"+ myRecAudioDir.getAbsolutePath());
	  			// myPlayFile = new File(myRecAudioDir.getAbsolutePath() + File.separator + ((CheckedTextView) arg1).getText());
	  			myTextView1.setText("你选的是："+ ((CheckedTextView) arg1).getText());
	  		}
	  	}); 
